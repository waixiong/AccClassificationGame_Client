...
var Game = new Phaser.Class({
        ...
        var tween = _this.tweens.add({
            ...
            onComplete: function() {
                ...
                _this.tweens.add({
                    ...
                    onComplete: function() {
                        // get score
                        _this.respondList.push(old_box.box_data);
                        _this._checkanswer(_this.respondList[_this.respondList.length-1]);
                        old_box.destroy();
                        if(_this.respondList.length == QUESTION_NUMBER){
                            // endgame
                            _this.already_end = true;
                        }
                    }
                });
            }
    ...
    create_box: function(question) {
        ...
        this.box = this.physics.add.image(550, 700, 'box');
        this.box.scale = 0.8;
        this.box.depth = 2;
